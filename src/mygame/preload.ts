...
export function preload() {
    ...
    prepareLoad(AssetLoader.Sound, "buzz", "buzz.ogg")
    prepareLoad(AssetLoader.Sound, "bong", "bong.ogg")
    prepareLoad(AssetLoader.Sound, "eeeee", "eeeee.ogg")
    prepareLoad(AssetLoader.Sound, "scroff", "scroff.ogg")
    prepareLoad(AssetLoader.Sound, "oa", "oa.ogg")
    prepareLoad(AssetLoader.Sound, "burp", "burp.ogg")
